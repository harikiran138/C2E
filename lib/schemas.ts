...
export const memberSchema = z.object({
  member_name: z.string().min(2, { message: "Name must be at least 2 characters." }),
...
export const peoSchema = z.object({
  statement: z.string().min(10, { message: "PEO statement must be at least 10 characters long." }),
});
