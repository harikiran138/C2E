...
export const PROCESS_STEPS: ProcessStep[] = [
  ...
  },
  {
    ...
    description:
      "Add representative stakeholders for consultation and validation.",
    icon: "UserPlus",
  },
  {
    key: "process-6",
  ...
  },
  {
    ...
    phase: "Stakeholder & PEOs",
    description:
      "Configure stakeholder timeline and review consolidated Vision, Mission and PEO feedback.",
    icon: "MessageSquare",
  },
  {
    key: "process-8",
    ...
    phase: "Stakeholder & PEOs",
    description:
      "Generate consistency matrix between mission components and PEOs.",
    icon: "Grid",
  },
  {
    key: "process-9",
  ...
  },
  {
    ...
    phase: "Program Outcomes",
    description:
      "Track dissemination actions across approved communication channels.",
    icon: "Share2",
  },
  {
    key: "process-12",
  ...
  },
  {
    ...
    phase: "Curriculum Development",
    description:
      "Generate course outcomes mapped to revised Bloom taxonomy levels.",
    icon: "FileText",
  },
  {
    key: "process-15",
    ...
    phase: "Curriculum Development",
    description:
      "Fill curriculum in a structured table/Excel-style prescribed format.",
    icon: "Table",
  },
  {
    key: "process-16",
    ...
    description:
      "Create and float curriculum feedback form on the right-side panel.",
    icon: "MessageSquare",
  },
  {
    key: "process-17",
...
export const SIDE_MENU_STEPS = PROCESS_STEPS.filter(
  (step) => step.section === "side_menu",
);
export const PROCESS_MENU_STEPS = PROCESS_STEPS.filter(
  (step) => step.section === "process",
);
