      ...
      <div className="flex items-center justify-center p-4 py-20">
        <div className="bg-white dark:bg-slate-800 p-12 rounded-xl shadow-2xl max-w-lg w-full text-center space-y-6 border border-slate-100 dark:border-slate-700 animate-in zoom-in-95 duration-500">
          ...
          <div className="space-y-2">
            <h2 className="text-3xl font-semibold text-slate-900 dark:text-white font-serif">
              Thank You!
            </h2>
            <p className="text-slate-500 dark:text-slate-400 font-medium">
              Your feedback is invaluable in shaping the future of our{" "}
      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-8 items-start">
        ...
        <aside className="hidden lg:block w-72 sticky top-12 space-y-4">
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-xl border border-slate-100 dark:border-slate-700">
            <h4 className="text-xs font-semibold text-slate-400 uppercase tracking-[0.2em] mb-6 px-2">
              Navigation
            </h4>
          ...
          <div className="bg-slate-900 rounded-xl p-6 text-white shadow-xl relative overflow-hidden">
            ...
            <h5 className="text-xs font-semibold text-slate-400 uppercase tracking-widest mb-4">
              Your Progress
            </h5>
            <div className="space-y-2">
              ...
              <p className="text-[10px] font-semibold text-primary-gold uppercase tracking-widest">
        ...
        <div className="flex-1 max-w-4xl bg-white dark:bg-slate-800 rounded-xl shadow-2xl overflow-hidden border border-slate-100 dark:border-slate-700">
          ...
          <div className="bg-slate-900 p-12 text-white relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-4">
              ...
              <h1 className="text-4xl font-semibold font-serif leading-tight">
                Program Educational Objectives (PEOs) – Stakeholder Survey
              </h1>
              ...
              <p className="text-sm text-slate-400 max-w-2xl leading-relaxed italic pt-2">
                Program Educational Objectives (PEOs) describe what graduates
                are expected to achieve 3–5 years after graduation. Your input
                helps us refine these goals.
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-12 space-y-12">
            ...
            <section>
              <SectionHeader
                icon={User}
                title="SECTION A: Stakeholder Profile"
                id="profile"
              />
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="md:col-span-2 space-y-3">
                  <label className="text-xs font-semibold text-slate-400 uppercase tracking-widest ml-1">
                    Years of association with Mechanical Engineering
                  </label>
                  <div className="flex flex-wrap gap-4">
                    {["< 3 years", "3–5 years", "5–10 years", ">10 years"].map(
                      (opt) => (
                        <label
                          key={opt}
                        ...
                        >
                          <input
                            ...
                            onChange={(e) =>
                              setFormData({
                                ...formData,
                                association_years: e.target.value,
                              })
                            }
                          />
                          {opt}
            ...
            <section>
              <SectionHeader
                icon={Briefcase}
                title="SECTION B: Career Progression & Outcomes (3–5 Years)"
                id="career"
              />
              <div className="space-y-6">
                <div className="space-y-3">
                  <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">
                    Professional roles a graduate should be able to perform 3–5
                  ...
                  <div className="grid sm:grid-cols-2 gap-3">
                    {[
                      ...
                      "Higher Studies / Research Scholar",
                      ...
                      >
                        <input
                          ...
                          onChange={() =>
                            handleCheckboxChange("career_roles", role)
                          }
                ...
                <div className="space-y-3">
                  <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">
                    What defines professional success for a graduate?
                  </p>
                  <div className="flex flex-wrap gap-3">
                    {[
                      ...
                      <label
                        key={item}
                        className={`px-5 py-3 rounded-full border transition-all cursor-pointer font-semibold text-xs uppercase tracking-wider ${
                      ...
                      >
                        <input
                          type="checkbox"
                          className="hidden"
                          checked={formData.success_definition.includes(item)}
                          onChange={() =>
                            handleCheckboxChange("success_definition", item)
                          }
                        />
                        {item}
                      </label>
            ...
            <section>
              <SectionHeader
                icon={BookOpen}
                title="SECTION C: Technical Competence & Core Knowledge"
                id="technical"
              />
              <div className="space-y-8">
                <div className="space-y-3">
                  <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">
                    Rate the importance of strong fundamentals for long-term
                    success:
                  </p>
                      ...
                      >
                        <input
                          ...
                          onChange={(e) =>
                            setFormData({
                              ...formData,
                              fundamentals_importance: e.target.value,
                            })
                          }
                        />
                        {opt}
                ...
                <div className="space-y-3">
                  <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">
                    Critical core domains for future careers (Multiple choice):
                  </p>
                  <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-3">
                    {[
                      ...
                      >
                        <input
                          type="checkbox"
                          checked={formData.core_domains.includes(domain)}
                          onChange={() =>
                            handleCheckboxChange("core_domains", domain)
                          }
                          className="size-4"
                        />
                        {domain}
                ...
                <div className="space-y-3">
                  <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">
                    Problem-solving ability level expected after 3–5 years:
                  </p>
                  <div className="grid sm:grid-cols-2 gap-4">
                    {[
                      "Routine problem execution",
                      ...
                      <label
                        key={level}
                        className={`p-5 rounded-[1.5rem] border transition-all cursor-pointer space-y-2 ${
                      ...
                      >
                        <input
                          ...
                          onChange={(e) =>
                            setFormData({
                              ...formData,
                              problem_solving_level: e.target.value,
                            })
                          }
                        />
                        <div className="flex items-center justify-between">
                          <span
                            className={`text-sm font-semibold ${formData.problem_solving_level === level ? "text-slate-900" : "text-slate-600"}`}
                          >
                            {level}
                          </span>
                          {formData.problem_solving_level === level && (
                            <CheckCircle2 className="size-5 text-primary-gold" />
                          )}
                        </div>
                      </label>
                    ))}
            ...
            <section>
              <SectionHeader
                icon={Zap}
                title="SECTION D: Emerging Technologies & Future Readiness"
                id="future"
              />
              <div className="space-y-6">
                <div className="space-y-3">
                  <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">
                    Emerging areas PEOs should emphasize:
                  </p>
                  <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-3">
                    {[
                      "CAD / CAE / CFD / FEA",
                      ...
                      >
                        <input
                          ...
                          onChange={() =>
                            handleCheckboxChange("emerging_areas", area)
                          }
                          className="size-4"
                        />
                        {area}
                ...
                <div className="space-y-3">
                  <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">
                    Importance of multidisciplinary capability (Mechanical +
                    Electrical + Software):
                  </p>
                  <div className="flex gap-4">
                    {["Very High", "High", "Moderate", "Low"].map((opt) => (
                      ...
                      >
                        <input
                          ...
                          onChange={(e) =>
                            setFormData({
                              ...formData,
                              multidisciplinary_importance: e.target.value,
                            })
                          }
                        />
                        {opt}
            ...
            <section>
              <SectionHeader
                icon={Award}
                title="SECTION E: Professional Skills, Ethics & Responsibility"
                id="skills"
              />
              <div className="space-y-8">
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full text-left min-w-[600px]">
                      <thead className="bg-slate-50 dark:bg-slate-900/50 border-b border-slate-200 dark:border-slate-700">
                        <tr>
                          <th className="p-5 text-sm font-semibold text-slate-400 uppercase tracking-widest">
                            Skill
                          </th>
                          {["Very Important", "Important", "Moderate"].map(
                            (h) => (
                              <th
                                key={h}
                                className="p-5 text-center text-xs font-semibold text-slate-400 uppercase tracking-widest"
                              >
                                {h}
                              </th>
                            ),
                      ...
                      <tbody className="divide-y divide-slate-200 dark:divide-slate-700">
                        {[
                          ...
                          >
                            <td className="p-5 text-sm font-semibold text-slate-700 dark:text-slate-300">
                              {skill}
                            </td>
                            {["Very Important", "Important", "Moderate"].map(
                              (rating) => (
                ...
                <div className="space-y-3">
                  <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">
                    Importance of ethics, safety, and quality practices:
                  </p>
                  <div className="flex gap-4">
                    {["Very High", "High", "Moderate", "Low"].map((opt) => (
                      <label
                      ...
                      >
                        <input
                          ...
                          onChange={(e) =>
                            setFormData({
                              ...formData,
                              ethics_importance: e.target.value,
                            })
                          }
                        />
                        {opt}
            ...
            <section>
              <SectionHeader
                icon={GraduationCap}
                title="SECTION F: Lifelong Learning, Research & Growth"
                id="learning"
              />
              <div className="space-y-8">
                <div className="space-y-3">
                  <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">
                    Should graduates be encouraged towards continuous learning?
                  </p>
                  <div className="flex gap-4">
                      ...
                      >
                        <input
                          ...
                          onChange={(e) =>
                            setFormData({
                              ...formData,
                              lifelong_learning: e.target.value,
                            })
                          }
                        />
                        {opt}
                ...
                <div className="space-y-3">
                  <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">
                    Pathways PEOs should explicitly support (Multiple choice):
                  </p>
                  <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-3">
                    {[
                      "Higher Studies (M.Tech / MS / Ph.D.)",
                      ...
                      >
                        <input
                          type="checkbox"
                          checked={formData.pathways.includes(path)}
                          onChange={() =>
                            handleCheckboxChange("pathways", path)
                          }
                          className="size-4"
                        />
                        {path}
                ...
                <div className="space-y-3">
                  <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">
                    Importance of exposure to research, innovation, and patents:
                  </p>
                  <div className="flex gap-4">
                    {["Very High", "High", "Moderate", "Low"].map((opt) => (
                      <label
                      ...
                      >
                        <input
                          ...
                          onChange={(e) =>
                            setFormData({
                              ...formData,
                              research_importance: e.target.value,
                            })
                          }
                        />
                        {opt}
            ...
            <section>
              <SectionHeader
                icon={Globe}
                title="SECTION G: Global, Societal & Sustainability Perspective"
                id="societal"
              />
              <div className="space-y-8">
                <div className="space-y-3">
                  <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">
                    Should graduates be prepared for global careers?
                  </p>
                  <div className="flex gap-4">
                ...
                <div className="space-y-3">
                  <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">
                    Role Mechanical engineers should play in societal/national
                    development:
                  </p>
                  <div className="grid sm:grid-cols-2 gap-3">
                    {[
                      ...
                      >
                        <input
                          type="checkbox"
                          checked={formData.societal_role.includes(role)}
                          onChange={() =>
                            handleCheckboxChange("societal_role", role)
                          }
                          className="size-4"
                        />
                        {role}
            ...
            <section>
              <SectionHeader
                icon={Eye}
                title="SECTION H: Program Differentiation & Institutional Vision"
                id="vision"
              />
              <div className="space-y-8">
                <div className="space-y-2">
                  <label className="text-sm font-semibold text-slate-700 dark:text-slate-300">
                    What should distinguish graduates of this Mechanical
                    Engineering program from others?
                  </label>
                  <textarea
            ...
            <section>
              <SectionHeader
                icon={CheckCircle2}
                title="SECTION I: PEO Validation (Accreditation Key)"
                id="validation"
              />
              <div className="space-y-8">
                <div className="space-y-3">
                  <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">
                    In your view, 3–5 years after graduation, a graduate should
                    demonstrate:
                  </p>
                    ...
                    {[
                      ...
                      >
                        ...
                        <input
                          ...
                          onChange={() =>
                            handleCheckboxChange("peo_validation", item)
                          }
                        />
                        {item}
                      </label>
                ...
                <div className="space-y-3">
                  <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">
                    Do you feel stakeholder expectations are adequately
                    reflected in current PEOs?
                  </p>
                  <div className="flex gap-4">
                      ...
                      >
                        <input
                          ...
                          onChange={(e) =>
                            setFormData({
                              ...formData,
                              expectations_reflected: e.target.value,
                            })
                          }
                        />
                        {opt}
                ...
                <div className="space-y-2">
                  <label className="text-sm font-semibold text-slate-700 dark:text-slate-300">
                    What future competencies should PEOs emphasize more
                    strongly?
                  </label>
                  <textarea
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        future_competencies: e.target.value,
                      })
                    }
                    className="w-full bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 p-5 rounded-[1.5rem] outline-none focus:border-primary-gold transition-all font-medium text-slate-800 dark:text-slate-200"
                  />
            ...
            <section>
              <SectionHeader
                icon={MessageSquare}
                title="SECTION J: Additional Suggestions"
                id="additional"
              />
              <div className="space-y-4">
                <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">
                  Any additional comments or recommendations for improving PEOs:
                </p>
                <textarea
