  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between border-b border-slate-200 pb-4">
        <div>
          <h3 className="text-2xl font-bold tracking-tight text-slate-900">OBE Framework & Protocols</h3>
          <p className="text-sm font-medium text-slate-500 mt-1">Define Framework Members</p>
        </div>
        {isLocked && (
          <div className="flex gap-2">
            ...
            >
              <Edit2 className="size-4" /> Edit Framework
            </button>
          </div>
        )}
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-4 pt-4">
            ...
            {!isLocked && members.length > 0 && (
              ...
              >
                <Lock className="size-5" /> Lock Framework
              </button>
            )}
            ...
            {isLocked && !editingId && (
              <div className="flex-1 flex items-center justify-center py-3.5 px-6 rounded-xl bg-slate-50 border border-slate-200 text-slate-500 font-bold text-sm gap-2">
                <Lock className="size-4" /> Framework Locked
              </div>
            )}
          </div>
        </form>
                                        ...
                                        <div className="px-4 pb-4 pt-0 border-t border-slate-100/80 bg-slate-50/50">
                                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 pt-4">
                                                ...
                                                <div className="p-3 bg-white rounded-lg border border-slate-100 shadow-sm">
                                                    ...
                                                    <div className="text-sm font-medium text-slate-700">{member.email_official || 'N/A'}</div>
                                                </div>
                                                ...
                                                <div className="p-3 bg-white rounded-lg border border-slate-100 shadow-sm">
                                                    ...
                                                    <div className="text-sm font-medium text-slate-700">{member.email_personal || 'N/A'}</div>
                                                </div>
                                                ...
                                                <div className="p-3 bg-white rounded-lg border border-slate-100 shadow-sm">
                                                    ...
                                                    <div className="text-sm font-medium text-slate-700">{member.mobile_personal || 'N/A'}</div>
                                                </div>
