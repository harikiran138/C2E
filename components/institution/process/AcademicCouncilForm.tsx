...
export default function AcademicCouncilForm() {
  ...
  const handleEdit = (member: any, e: React.MouseEvent) => {
    ...
    // Scroll to form
    const formElement = document.getElementById('ac-form');
    if (formElement) {
  ...
  return (
    <div className="space-y-8 animate-element">
      {/* Main Form Section */}
      <div id="ac-form" className="group rounded-[1.5rem] border border-slate-200 bg-white p-8 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] transition-all hover:shadow-[0_8px_30px_-4px_rgba(0,0,0,0.08)]">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <div className="grid grid-cols-1 gap-x-8 gap-y-6 md:grid-cols-2">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input 
                    ...
                    className={cn(
                        "w-full h-11 pl-10 rounded-xl border bg-slate-50/50 pr-4 text-sm font-semibold text-slate-900 placeholder:text-slate-400 focus:bg-white focus:ring-4 focus:ring-indigo-500/10 transition-all outline-none",
               ...
               <div className="flex items-center gap-1.5">
                ...
                <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p className="text-xs font-medium">As per academic council rules</p>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
              </div>
            ...
            {/* LinkedIn Field */}
            <div className="space-y-1.5">
              <label className="text-xs font-bold uppercase tracking-widest text-slate-500">LinkedIn ID</label>
              <div className="relative">
                <div className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400">
          ...
          <div className="flex gap-4 pt-6 border-t border-slate-100 mt-6">
            ...
            {!isLocked && members.length > 0 && (
              ...
              >
                <Lock className="size-5 text-slate-400" /> Lock Council
              </button>
            )}
      ...
      <div className="space-y-4 pt-4">
        <h3 className="flex items-center gap-2 text-sm font-bold uppercase tracking-widest text-slate-500 mb-4 px-1">
           <Users className="size-4 text-indigo-500" /> Council Members 
        ...
        <div className="grid grid-cols-1 gap-4">
            {loading ? (
                ...
                <div className="flex flex-col items-center justify-center py-20 bg-white rounded-[1.5rem] border border-slate-200 border-dashed text-center">
                    ...
                    <p className="text-sm text-slate-500 max-w-xs mt-1 mb-6">Constituent members for the Academic Council haven't been added yet.</p>
