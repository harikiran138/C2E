...
import { TrendingUp, TrendingDown, Users, FileText, ShieldCheck, ChevronRight } from 'lucide-react';
            ...
            <Link href={stat.href}>
                <Card className="relative h-full overflow-hidden border-border/60 bg-white/50 hover:bg-white transition-all duration-300 shadow-sm hover:shadow-xl hover:border-indigo-100 flex flex-col justify-between p-7 rounded-[24px] group">
                    ...
                    <div className={cn(
                        ...
                        colorStyles[stat.color as keyof typeof colorStyles] || 'bg-slate-50 text-slate-400',
                    ...
                    <div>
                        <p className="text-[10px] font-black uppercase tracking-[0.15em] text-slate-400 mb-4">{stat.title}</p>
