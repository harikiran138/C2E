...
import { GraduationCap, Users, Award, BookOpen, Sparkles } from "lucide-react";
          ...
          >
            ...
            <div className="relative z-10 flex flex-col gap-6">
              <div className="flex items-center justify-between">
                ...
                <div
                  className={cn(
                    "p-3 rounded-2xl shadow-lg shadow-indigo-50 transition-all duration-500 group-hover:scale-110",
