      ...
      >
        <div
          className={cn(
            ...
            isScrolled
              ? "bg-white/90 backdrop-blur-xl border border-[#c9a961]/20 rounded-full px-6 py-2 shadow-xl shadow-black/5"
              : "bg-transparent py-2",
          )}
        >
          {/* Left Side: Logo & Menu */}
              ...
              <div className="relative w-12 md:w-16 h-12 md:h-16 flex items-center justify-center">
                <AnimatePresence mode="wait">
                  ...
                  >
                    <Image
                      src={
                        isScrolled ? "/C2XPlusb_text.jpeg" : "/Logo2w_text.jpeg"
                      }
                      alt="C2X Logo"
                      width={180}
                      height={60}
                      className={cn(
                        ...
                        !isScrolled &&
                          "brightness-110 drop-shadow-[0_0_15px_rgba(255,255,255,0.4)]",
                      )}
                      priority
                    />
                  </motion.div>
                ...
                return (
                  <Link
                    ...
                    className={cn(
                      ...
                      isActive
                        ? "text-[#c9a961]"
                        : "text-[#c9a961]/70 hover:text-[#c9a961]",
                    )}
                  >
                    {item.name}
                    {isActive && (
