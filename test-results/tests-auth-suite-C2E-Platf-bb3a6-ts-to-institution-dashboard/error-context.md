...
- Name: tests/auth-suite.spec.ts >> C2E Platform v5.1 - Authentication Suite >> TC-1.04: Institute Admin Login Redirects to /institution/dashboard
- Location: tests/auth-suite.spec.ts:39:7
