...
- Name: tests/auth-suite.spec.ts >> C2E Platform v5.1 - Authentication Suite >> TC-1.06: Institute Admin Rejects "Super Admin" Login on /institution/login
- Location: tests/auth-suite.spec.ts:59:7
        ...
        - generic [ref=e16]:
          ...
          - generic [ref=e34]:
            - generic [ref=e35]:
              ...
              - generic [ref=e41]:
                - img
                - textbox "institution@example.com" [ref=e42]: super@c2e.com
              - generic [ref=e43]:
                - img [ref=e44]
                - text: Password
              - generic [ref=e48]:
