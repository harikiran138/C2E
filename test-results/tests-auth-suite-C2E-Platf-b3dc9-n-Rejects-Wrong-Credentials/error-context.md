...
- Name: tests/auth-suite.spec.ts >> C2E Platform v5.1 - Authentication Suite >> TC-1.05: Institute Admin Rejects Wrong Credentials
- Location: tests/auth-suite.spec.ts:49:7
        ...
        - generic [ref=e16]:
          ...
          - generic [ref=e34]:
            - generic [ref=e35]:
              ...
              - generic [ref=e41]:
                - img
                - textbox "institution@example.com" [ref=e42]: inst-a@test.com
              - generic [ref=e43]:
                - img [ref=e44]
                - text: Password
              - generic [ref=e48]:
                - textbox "••••••••" [ref=e49]: WrongPass!
                - button [ref=e50]:
                  - img [ref=e51]
